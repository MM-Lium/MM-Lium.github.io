...
var myscript = function () {
    ...
    const daylabels = [{
            // 1
            week: ['2022/10/1', '2022/10/1', '2022/10/2', '2022/10/3', '2022/10/4', '2022/10/5', '2022/10/6', '2022/10/7', ''],
            mayorlabel: [{
                name: '蔣萬安', //候選人姓名
                color: blue, //候選人顏色
                score: '26.1', //候選人分數
                ...
                image: 't1', //候選人頭貼
                profilelink: ['https://www.w3schools.com/colors/default.asp'] //候選人的profile
            }, {
                name: '陳時中',
                color: green,
                score: '27',
                ...
                image: 't2',
                profilelink: ['https://www.w3schools.com/colors/colors_names.asp']
            }, {
                name: '黃珊珊',
                color: verdant,
                score: '28',
                ...
                link: ['https://www.chartjs.org/docs/latest/configuration/interactions.html#events', 'https://www.chartjs.org/docs/latest/configuration/interactions.html#events', '', '', '', '', '', ''],
                image: 't3',
                profilelink: ['https://www.w3schools.com/colors/colors_converter.asp']
            }, {
                name: '其他',
                color: purple,
                score: '',
                data: ['', '', 0],
                point: [4, 0, 0, 0, 0, 0, 0, 0],
                label: ['民進黨徵召名單公布1', '', '民進黨徵召名單公布1'],
                link: ['民進黨徵召名單公布1', '', 'https://www.chartjs.org/docs/latest/configuration/interactions.html#events', '', '', '', '', '', ''],
            }]
        },
        {
            // 2
            week: ['', '2022/10/10', '2022/10/2', '2022/10/3', '2022/10/4', '2022/10/5', '2022/10/6', '2022/10/7', ''],
            mayorlabel: [{
                name: '蔣萬安',
                color: blue,
                score: '26.1',
                ...
                link: ['https://www.chartjs.org/docs/latest/configuration/interactions.html#events', 'https://www.chartjs.org/docs/latest/configuration/interactions.html#events', '', '', '', '', '', ''],
                image: 't1',
                profilelink: ['https://www.w3schools.com/colors/default.asp']
            }, {
                name: '陳時中',
                color: green,
                score: '27',
        ...
        {
            // 3
            week: ['', '2022/10/20', '2022/10/2', '2022/10/3', '2022/10/4', '2022/10/5', '2022/10/6', '2022/10/7', ''],
            mayorlabel: [{
                name: '蔣萬安',
                color: blue,
                score: '26.1',
    ...
    const annotation = {
        ...
        borderWidth: 2,
        xMax: function () {
            var go = daylabels[_nowdaylabels].mayorlabel[3].data;
    ...
    const externalTooltipHandler = (context) => {
            ...
            if (element < _dall.length - 1) {
                ...
                if (_dname.length == _dall.length - 1) {
                    ...
                    _dname.forEach(function (i, element) {
                        ...
                        const myall_num2 = document.createElement('font');
                        _div.appendChild(document.createTextNode(_dname[element][0]));
                        myall_num2.appendChild(document.createTextNode(_dname[element][1]));
                        _div.appendChild(myall_num2);
                    })
                }
            }
        })

        tableBody.appendChild(_div);
        ...
        tooltipEl.style.top = tooltip.caretY - _Height * 1 - 15 + 'px';
    ...
    //產出折線圖
    const myChart = new Chart($('#myChart_mayor'),
        config
    );
    ...
    function chartImg() {
        ...
        ImgAni.to($('.mayorChart .allimg'), 1, {
            autoAlpha: 1,
            ease: Linear.easeNone
        });

        $('.mayorChart .allimg .box').each(function () {
    ...
    $('.mayorChart .Chart .btn._prev').click(function () {
    ...
    $('.mayorChart .Chart .btn._next').click(function () {
    ...
    function update(_nowday) {
        ...
        myChart.data.labels = daylabels[_nowday].week;

        myChart.data.datasets.forEach(function (i, item) {
            myChart.data.datasets[item].pointRadius = daylabels[_nowday].mayorlabel[item].point;
            myChart.data.datasets[item].data = daylabels[_nowday].mayorlabel[item].data;
        })
