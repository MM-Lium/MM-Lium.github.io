var script = function () {
    ...
    $(document).ready(function () {
        ...
        if (winW >= 769) {
            ...
            TweenMax.to(first_skip, 5, {
                autoAlpha: 1,
                delay: 9,
                ease: Linear.easeNone
            });
            TweenMax.to(first_skip, 6, {
                css: {
                    zIndex: 999
                },
                delay: 9,
        ...
        function counter() {
            ...
            TweenMax.to('.counter .load2', 1, {
                autoAlpha: 1,
                delay: 1,
                ease: Linear.easeNone
            });
            TweenMax.to('.counter .load', 1, {
                autoAlpha: 1,
                delay: 1,
                ease: Linear.easeNone
            });
    ...
    if (winW > 768) {
        ...
        timeline.on('wheel', (function (e) {
            ...
            if (i == 0) {
                if (e.originalEvent.wheelDelta > 0 || e.originalEvent.wheelDelta == 1) {
                    if (newT == timeline) {
                ...
                } else if (e.originalEvent.wheelDelta < 0 || e.originalEvent.wheelDelta == -1){
                    if (newT <= down) {
    ...
    function formspin() {
        ...
        setTimeout(function () {
            ...
            TweenMax.to('.lucky .after', 2, {
                autoAlpha: 1,
                delay: 1,
                ease: Linear.easeInOut
            });
            TweenMax.to('.lucky .before', 4, {
                opacity: 0,
                delay: 2,
                ease: Linear.easeInOut
            });
    ...
    $('.audio .play').click(function () {
        ...
        if (lbname == "podcast1") {
            $('.podcast iframe').attr('src', 'https://player.soundon.fm/embed?podcast=baf7588a-ed23-411f-9422-d58b0a2bbd25&episode=7843aeaa-5e42-4431-9415-5bd7456cf7f1');
    ...
    var lbOpen2 = function (lb_data) {
        ...
        var lbAni = new TimelineMax();
        lbAni.to($('.lb2[data-lb="' + lb_data + '"]'), .5, {
                css: {
                    zIndex: 999
                }
            }, '-=.5')
            .to($('.lb2[data-lb="' + lb_data + '"]'), .5, {
                autoAlpha: 1,
                ease: Linear.easeNone
            });

        // $('.lb2[data-lb="' + lb_data + '"]').addClass('popen');

    }

    var lbClose = function (comp) {
    ...
    var lbClose2 = function (lb_data) {
        ...
        var lbCloseAni = new TimelineMax();
        lbCloseAni.to($('.lb2[data-lb="' + lb_data + '"]'), .5, {
                autoAlpha: 0,
                ease: Linear.easeNone
            })
            .to($('.lb2[data-lb="' + lb_data + '"]'), .5, {
