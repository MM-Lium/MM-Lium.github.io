...
var myscript = function () {
    ...
    // 取得API---> 1
    // $.getJSON('https://reqres.in/api/users', function (apidata) {
    //     getData(apidata);
    // })
    ...
    // 取得API---> 4
    $.get('https://reqres.in/api/users', function (apidata) {
        console.log(apidata);
    })
    ...
    const thedate = [{
        id: 1,
        week: ['2022/10/11', '2022/10/2', '2022/10/3', '2022/10/4', '2022/10/5', '2022/10/6', '2022/10/7', ''],
    }, {
        id: 2,
    ...
    function getData(apidata) {
        ...
        console.log(apidata);
        myChart_data = apidata.data;

        console.log(myChart_data);

        data = {
            labels: thedate[0].week,
            datasets: [{
                label: myChart_data[0].first_name,
                backgroundColor: blue[0],
                borderColor: blue[1],
                data: "20",
                pointBorderColor: blue[1],
                pointRadius: "5",
            }]
        };
